      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <a
              href="https://www.instagram.com/rc__urbanpoona/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 p-2 rounded-full bg-white/10 hover:bg-accent hover:text-accent-foreground transition-colors"
            >
              <Instagram size={20} />
            </a>
          </div>
          ...
          <div className="min-w-0">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-primary-foreground/70 min-w-0">
                ...
                <a
                  href="mailto:urbanpoona2025@gmail.com"
                  className="hover:text-accent transition-colors text-sm break-all min-w-0"
                >
