    ...
    return useMutation({
        mutationFn: function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, fetch(api.volunteers.create.path, {
                    ...
                    case 1:
                        ...
                        _b = (_a = api.volunteers.create.responses[400]).parse;
                        return [4 /*yield*/, res.json()];
                    case 2:
                        error = _b.apply(_a, [_e.sent()]);
                        throw new Error(error.message || "Validation failed");
                    case 3: throw new Error("Failed to submit application");
                    case 4:
                        _d = (_c = api.volunteers.create.responses[201]).parse;
                        return [4 /*yield*/, res.json()];
