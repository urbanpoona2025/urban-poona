...
import { Users, Droplets, Map, Trophy, ArrowRight, Heart } from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-12">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link 
                href="/join" 
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-accent text-accent-foreground font-bold text-lg hover:bg-accent/90 hover:-translate-y-1 transition-all duration-300 shadow-[0_0_20px_rgba(255,193,0,0.4)]"
              >
                Become a Volunteer
              </Link>
              <Link 
                href="/projects" 
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/10 text-white font-bold text-lg backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
                View Our Work
              </Link>
            </div>
      ...
      <section className="py-24 bg-background relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="/images/events/basketball-fundraiser-league/img12.jpeg"
                alt="UPBFL Basketball Fundraiser League"
                className="rounded-3xl shadow-2xl z-10 relative w-full object-cover"
              />
      ...
      <section className="py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-card rounded-3xl overflow-hidden shadow-xl border border-border/50 grid grid-cols-1 md:grid-cols-2"
          >
            ...
            <div className="p-10 md:p-14 flex flex-col justify-center">
              ...
              <Link 
                href="/join" 
                className="inline-flex justify-center items-center px-6 py-3 rounded-xl bg-primary text-white font-semibold hover:bg-primary/90 transition-colors self-start"
              >
                Help Us Prepare
              </Link>
            </div>
