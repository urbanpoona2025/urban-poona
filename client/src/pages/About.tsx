    ...
    <div className="pt-24 pb-20">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            <img
              src="/images/events/visit-to-grip-charitable-foundation/img4.jpeg"
              alt="UPIC volunteers at GRIP Charitable Foundation"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white p-10 rounded-3xl shadow-xl shadow-primary/5 border border-primary/10 relative overflow-hidden group"
          >
